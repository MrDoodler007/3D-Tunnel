...
void loop() {
    ...
    strip1.setPixelColor(0, strip1.Color(ac[0], ac[1], ac[2]));
    strip1.setPixelColor(1, strip1.Color(tg[0], tg[1], tg[2]));
    strip2.setPixelColor(0, strip2.Color(ac[0], ac[1], ac[2]));
    strip2.setPixelColor(1, strip2.Color(tg[0], tg[1], tg[2]));
    strip1.show();
    strip2.show();
